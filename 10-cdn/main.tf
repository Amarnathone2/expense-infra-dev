resource "aws_cloudfront_distribution" "web_cdn" {
  origin {
    domain_name              =  "web-${var.environment}.${var.zone_name}"#web-csvdev.daws78s.online
  ...
  aliases = ["web-${var.common_tags.Component}.${var.zone_name}"]#web-cdn.csvdaws78s.online
...
module "records" {
  ...
  records = [
    {
      name    = "web-cdn" #web-cdn.csvdaws78s.online
      type    = "A"
